...
componentDidMount( ){
    document.getElementsByClassName('W(100%)')[0].children[0].remove()
    document.getElementsByClassName('W(100%)')[1].children[0].remove()
    console.log(document.getElementsByClassName('D(ib)')[3].innerText)
